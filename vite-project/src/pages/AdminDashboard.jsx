...
export default function AdminDashboard() {
  ...
  async function loadData() {
    try {
      setLoading(true);
      const [statsData, usersData, tasksData, categoriesData] =
        await Promise.all([
          getAdminStats(),
          getUsers(),
          getAllTasksMonitoring(),
  ...
  async function handleDeleteUser(id) {
    const result = await Swal.fire({
      ...
      text: "Data yang dihapus tidak dapat dikembalikan permanen!",
      icon: "warning",
              ...
              <tbody>
                {tasks.map((task) => (
                  ...
                  >
                    ...
                    <td>
                      <span
                        className={`status ${task.isCompleted ? "done" : "pending"}`}
                      >
